    ...
    <section className='min-h-screen w-full flex flex-col gap-8 md:gap-0 px-2 md:px-10 bg-black text-white'>
      ...
      <div className="flex flex-col justify-around md:h-[80vh]">
        <div className="flex flex-col gap-10 md:gap-0 md:flex-row justify-between ">
          <img className='w-[70%] self-center md:w-[30%] rounded-md' src={dami} alt="dami" />
        ...
        <div className="flex justify-between mt-8 gap-10 md:gap-0 md:px-10 overflow-scroll md:overflow-auto">
          <img src={image1} alt="" />
          <img src={image2} alt="" />
          <img src={image4} alt="" />
          <img src={image3} alt="" />
